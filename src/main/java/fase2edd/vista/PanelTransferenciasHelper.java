...
public class PanelTransferenciasHelper {
    ...
    // Obtener el producto desde el inventario origen
    controlador.setSucursalActiva(idOrigen);
    ...
    // Preparar la transferencia paso a paso
    ...
    // Obtener datos del simulador y actualizar etiquetas
    SimuladorDespacho sim = controlador.getCtrlTransferencias().getSimulador();
    rutaActual = sim.getRuta();                     // guardamos la ruta
    ...
    // Refrescar visualización de colas
    actualizarColasVisual();
}
